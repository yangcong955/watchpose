...
%
%   I     - inpainted image
function A = f_patch_inpaint(Aorg,Morg, verbose, sigma) 
...
if ~exist('f_CSH_nn.m','file')
    error('f_CSH_nn not found. Please download and add to path:  http://www.eng.tau.ac.il/~simonk/CSH/index.html');
end
...
for logscale = startscale:0
    ...
    for iter = 1:iterations
        ...
        % Compute NN field
        CSH_ann = f_CSH_nn(A,B,width,csh_iterations,k,calcBnn,M);
